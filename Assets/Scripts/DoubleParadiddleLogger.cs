...
public class DoubleParadiddleLogger : MonoBehaviour
{
    ...
    private doubparaLeftStickManager LscriptManager;
    ...
    void Start()
    {
        ...
        */
        ...
        string path = Application.persistentDataPath + "/" + "TrackingLogs" + "/" + "headPosition&Orientation_DoubleParadiddle_" +
                     System.DateTime.Now.ToString("MM-dd-yyy-HH-mm-ss") + ".txt";

        string path2 = Application.persistentDataPath + "/" + "TrackingLogs" + "/" + "handPosition&Orientation_DoubleParadiddle_" +
                     System.DateTime.Now.ToString("MM-dd-yyy-HH-mm-ss") + ".txt";

        string path3 = Application.persistentDataPath + "/" + "TrackingLogs" + "/" + "accuracyPercentage_DoubleParadiddle_" +
                     System.DateTime.Now.ToString("MM-dd-yyy-HH-mm-ss") + ".txt";
