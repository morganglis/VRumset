...
public class ParadiddleLogger : MonoBehaviour
{
    ...
    private paraRightStickManager RscriptManager;

    public GameObject leftStick;
    private paraLeftStickManager LscriptManager;
    ...
    void Start()
    {
        ...
        */
        ...
        string path = Application.persistentDataPath + "/" + "TrackingLogs" + "/" + "headPosition&Orientation_Paradiddle_" +
                     System.DateTime.Now.ToString("MM-dd-yyy-HH-mm-ss") + ".txt";

        string path2 = Application.persistentDataPath + "/" + "TrackingLogs" + "/" + "handPosition&Orientation_Paradiddle_" +
                     System.DateTime.Now.ToString("MM-dd-yyy-HH-mm-ss") + ".txt";

        string path3 = Application.persistentDataPath + "/" + "TrackingLogs" + "/" + "accuracyPercentage_Paradiddle_" +
                     System.DateTime.Now.ToString("MM-dd-yyy-HH-mm-ss") + ".txt";
        ...
        RscriptManager = rightStick.GetComponent<paraRightStickManager>(); // Grab our right stick script
        LscriptManager = leftStick.GetComponent<paraLeftStickManager>();    // Grab our left stick script
    }
