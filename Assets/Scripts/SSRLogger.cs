...
public class SSRLogger : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        */
        ...
        string path = Application.persistentDataPath + "/" + "TrackingLogs" + "/" + "headPosition&Orientation_SSR_" +
                     System.DateTime.Now.ToString("MM-dd-yyy-HH-mm-ss") + ".txt";

        string path2 = Application.persistentDataPath + "/" + "TrackingLogs" + "/" + "handPosition&Orientation_SSR_" +
                     System.DateTime.Now.ToString("MM-dd-yyy-HH-mm-ss") + ".txt";

        string path3 = Application.persistentDataPath + "/" + "TrackingLogs" + "/" + "accuracyPercentage_SSR_" +
                     System.DateTime.Now.ToString("MM-dd-yyy-HH-mm-ss") + ".txt";
